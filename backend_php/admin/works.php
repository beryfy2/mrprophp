        ...
        <div class="admin-main">
            ...
            <div class="admin-content">
                <div class="page-header">
                    ...
                    <a href="work_form.php" class="btn btn-primary">Add New Work</a>
                </div>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="work_form.php?id=<?php echo $item['id']; ?>" class="action-btn btn-edit">Edit</a>
                            ...
                            <?php if (empty($items)): ?>
                            <tr>
                                <td colspan="4" style="text-align:center;">No works found.</td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
