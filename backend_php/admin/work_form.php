...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        // Update
        $query = "UPDATE works SET title = :title, content = :content, date = :date, photo = :photo WHERE id = :id";
        $stmt = $db->prepare($query);
        $stmt->bindParam(':id', $id);
    } else {
        // Insert
        $query = "INSERT INTO works (title, content, date, photo) VALUES (:title, :content, :date, :photo)";
        $stmt = $db->prepare($query);
    }
...
$pageTitle = $id ? 'Edit Work' : 'Add New Work';
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="admin-main">
            ...
            <div class="admin-content">
                <div class="page-header">
                    ...
                    <a href="works.php" class="btn btn-secondary">Back</a>
                </div>
